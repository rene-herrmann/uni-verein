...
1. **Fork** the repository
   ```bash
   git clone https://github.com/YOUR_USERNAME/uni-verein.git
   cd uni-verein
   ```
...
- 💬 **Discussions:** [GitHub Discussions](https://github.com/rene-herrmann/uni-verein/discussions)
- 🐛 **Issues:** [GitHub Issues](https://github.com/rene-herrmann/uni-verein/issues)
