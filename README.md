...
```bash
curl -O https://raw.githubusercontent.com/rene-herrmann/uni-verein/refs/tags/v1.0.0/nginx.conf
curl -O https://raw.githubusercontent.com/rene-herrmann/uni-verein/refs/tags/v1.0.0/docker-compose-ini.yml
curl -O https://raw.githubusercontent.com/rene-herrmann/uni-verein/refs/tags/v1.0.0/docker-compose-prod-image.yml
```

2. **Create .env and secrets**

```bash
touch .env && docker compose -f docker-compose-ini.yml up
```
...
```bash
docker compose -f docker-compose-prod-image.yml up
```
...
- GitHub: [@uni-verein](https://github.com/rene-herrmann/uni-verein)
